...
#include "belt_n_parcel_gazebo/ConveyorBeltState.h"
...
void ROSConveyorBeltPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->statePub = this->rosnode_->advertise<
    belt_n_parcel_gazebo::ConveyorBeltState>(stateTopic, 1000);
}

/////////////////////////////////////////////////
void ROSConveyorBeltPlugin::Publish() const
{
  belt_n_parcel_gazebo::ConveyorBeltState stateMsg;
...
bool ROSConveyorBeltPlugin::OnControlCommand(ros::ServiceEvent<
  belt_n_parcel_gazebo::ConveyorBeltControl::Request, belt_n_parcel_gazebo::ConveyorBeltControl::Response> & event)
{
  const belt_n_parcel_gazebo::ConveyorBeltControl::Request& req = event.getRequest();
  belt_n_parcel_gazebo::ConveyorBeltControl::Response& res = event.getResponse();
