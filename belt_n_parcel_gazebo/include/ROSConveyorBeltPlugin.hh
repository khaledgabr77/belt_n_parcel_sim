...
// ROS
#include <belt_n_parcel_gazebo/ConveyorBeltControl.h>
#include <ros/ros.h>
...
namespace gazebo
{
  ...
  class ROSConveyorBeltPlugin : public ConveyorBeltPlugin
  {
    ...
    public: bool OnControlCommand(ros::ServiceEvent<
      belt_n_parcel_gazebo::ConveyorBeltControl::Request,
      belt_n_parcel_gazebo::ConveyorBeltControl::Response> & event);
